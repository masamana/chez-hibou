...
<body>
    ...
    <div>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                    <!-- Navbar brand -->
                    <a class="navbar-brand mt-2 mt-sm-0" href="https://mdbootstrap.com/%22%3E
            <img src=" ./assets/img/logo.jpg" height="70" alt="Hello Hibou Logo" loading="lazy" />
                    </a>
                    <!-- Left links -->
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item active">
                            <a class="nav-link" href="https://mdbootstrap.com/%22%3EAccueil</a>
            </li>
            <li class=" nav-item">
                                <a class="nav-link" href="https://mdbootstrap.com/docs/standard/%22%3ELe restaurant</a>
            </li>
        ...
        <div class=" d-flex align-items-center">
                                    ...
                                    <a class="nav-link" href="https://mdbootstrap.com/docs/standard/getting-started/installation/%22%3E
